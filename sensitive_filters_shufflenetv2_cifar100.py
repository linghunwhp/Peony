...
def sensitive_filters(model_args, model, test_loader, mutual_classes, noise_var=0.5):
    ...
    sensitive_filters_all_file = 'results_shufflenetv2_cifar100/sensitive_filters_all_' + str(noise_var) + '.txt'
    sensitive_filters_each_class_file = 'results_shufflenetv2_cifar100/sensitive_filters_each_class_' + str(noise_var) + '.txt'
    ...
    for mutual_class in mutual_classes:
        ...
        for epoch in range(1, 26):
            ...
            if conf_matrix[mutual_class[0]][mutual_class[0]] + conf_matrix[mutual_class[1]][mutual_class[1]] + 5 > \
                ...
                torch.save(model.state_dict(), 'results_shufflenetv2_cifar100/mutual_class_' + str(mutual_class) + '_noise_var_' + str(noise_var) + '_epoch_' + str(epoch) + '.pth')
        ...
        file = open('results_shufflenetv2_cifar100/mutual_mis_all_epoch_var_' + str(noise_var) + '_unlearn_rate_' + str(unlearn_rate) + '_train_rate_' + str(train_rate) + '.txt', "w")
...
if __name__ == '__main__':
    ...
    mutual_misclassified_classes = [[47, 52], [35, 98], [55, 72]]
    ...
    if args.repairing:
        ...
        state_dict_3 = []
        state_dict_3.append(torch.load('results_shufflenetv2_cifar100/var_0.05/mutual_class_[47, 52]_noise_var_0.1_epoch_17.pth', map_location=settings.CUDA))
        state_dict_3.append(torch.load('results_shufflenetv2_cifar100/var_0.05/mutual_class_[35, 98]_noise_var_0.1_epoch_5.pth', map_location=settings.CUDA))
        state_dict_3.append(torch.load('results_shufflenetv2_cifar100/var_0.05/mutual_class_[55, 72]_noise_var_0.1_epoch_25.pth', map_location=settings.CUDA))
