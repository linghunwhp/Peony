...
if __name__ == '__main__':
    ...
    filters_in_all_aspects, filters_in_3_aspects = sensitive_filters(model_args=args, model=net, test_loader=testing_loader, mutual_classes=mutual_misclassified_classes, noise_var=1)
