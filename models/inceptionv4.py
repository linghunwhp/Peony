...
def inceptionv4(num_class=100):
    return InceptionV4(4, 7, 3, num_class=num_class)

def inception_resnet_v2(num_class=100):
    return InceptionResNetV2(5, 10, 5, num_class=num_class)
