...
class Attention(nn.Module):
    ...
    def __init__(self, block_num, num_class=100):
...
def attention56(num_class=100):
    return Attention([1, 1, 1], num_class=num_class)

def attention92(num_class=100):
    return Attention([1, 2, 3], num_class=num_class)
