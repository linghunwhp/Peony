...
class ResnetInResneet(nn.Module):
    def __init__(self, num_class=100):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(384, num_class, kernel_size=3, stride=2), #without this convolution, loss will soon be nan
...
def resnet_in_resnet(num_class=100):
    return ResnetInResneet(num_class=num_class)
