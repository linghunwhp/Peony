...
class AllCNN(nn.Module):
    def __init__(self, filters_percentage=1., n_channels=3, num_class=100, dropout=False, batch_norm=True):
...
def allcnn(num_class=100):
    return AllCNN(num_class=num_class)