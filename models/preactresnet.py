...
def preactresnet18(num_class=100):
    return PreActResNet(PreActBasic, [2, 2, 2, 2], num_class=num_class)

def preactresnet34(num_class=100):
    return PreActResNet(PreActBasic, [3, 4, 6, 3], num_class=num_class)

def preactresnet50(num_class=100):
    return PreActResNet(PreActBottleNeck, [3, 4, 6, 3], num_class=num_class)

def preactresnet101(num_class=100):
    return PreActResNet(PreActBottleNeck, [3, 4, 23, 3], num_class=num_class)

def preactresnet152(num_class=100):
    return PreActResNet(PreActBottleNeck, [3, 8, 36, 3], num_class=num_class)
