...
if __name__ == '__main__':
    ...
    patching(original_state_dict=torch.load(args.weights, map_location=settings.CUDA), new_model_state_dict=model_state_dicts_3_aspects[0], filters_for_aspects=filters_in_3_aspects)
